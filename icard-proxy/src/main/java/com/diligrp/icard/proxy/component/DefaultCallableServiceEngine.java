package com.diligrp.icard.proxy.component;

import com.diligrp.icard.proxy.domain.CallableComponent;
import com.diligrp.icard.proxy.domain.CallableServiceEndpoint;
import com.diligrp.icard.proxy.domain.ServiceRequest;
import com.diligrp.icard.proxy.util.WebConstants;
import com.diligrp.icard.shared.Constants;
import com.diligrp.icard.shared.util.ObjectUtils;
...
public class DefaultCallableServiceEngine implements ICallableServiceEngine, BeanPostProcessor {
    ...
    protected void registerCallableServiceEndpoint(Object target, String componentId, Method method) {
        ...
        if (types.length == 1 && types[0] instanceof ParameterizedType) {
            ...
            if (ObjectUtils.equals(method.getName(), WebConstants.DEFAULT_ENDPOINT_ID)) {
